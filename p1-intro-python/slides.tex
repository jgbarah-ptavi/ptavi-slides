...
\date[Sept 2014]{10 de septiembre de 2014}
...
{\tiny
(c) 2009-14 Gregorio Robles, Miguel Ortuño, Grupo de Sistemas y Comunicaciones \\
...
for x in pais.keys(): # iteramos por el diccionario
   print x, pais[x]

del pais['fr']   # borra esta llave (y su valor)
print len(pais) # devuelve el número de elementos en el diccionario
print pais.has_key('es') # True si hay una llave "es", False si no
pais.clear()  # vacía el diccionario
